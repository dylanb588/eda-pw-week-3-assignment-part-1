...
let favoriteFoods = ['Pizza', 'Tacos', 'Ice Cream', 'Buffalo Wings'];
...
console.log(animalArray[3], 'The last animal is', lastAnimal);
...
let dessert = 'Pumpkin Pie';
favoriteFoods.push(dessert)
console.log('Added dessert to the end, ', favoriteFoods);
...
console.log('Now the colors are: ', colors);
